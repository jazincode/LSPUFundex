        ...
        <div class="lspu-card">
            ...
            <div class="lspu-card-body p-0">
                <table class="lspu-table">
                    <thead>
                        <tr><th>Rank</th><th>Section</th><th class="text-end">Total Funds</th></tr>
                    </thead>
                    <tbody>
                    ...
                    <?php else: ?>
                        ...
                        <tr>
                            <td class="fw-bold" style="font-size:20px;"><?php echo $medals[$i]; ?></td>
                            <td>
    ...
    <div class="col-lg-6">
        <div class="lspu-card">
            ...
            <div class="lspu-card-body p-0">
                <table class="lspu-table">
                    <thead>
                        <tr><th>Rank</th><th>Section</th><th class="text-end">Balance</th></tr>
                    </thead>
                    <tbody>
                    ...
                    <?php else: ?>
                        ...
                        <tr>
                            ...
                            <td class="text-end">
                                <span class="fw-bold"
                                      style="color:<?php echo $row['balance'] >= 0 ? '#27ae60' : '#e74c3c'; ?>">
    ...
    <div class="col-lg-6">
        <div class="lspu-card">
            ...
            <div class="lspu-card-body p-0">
                <table class="lspu-table">
                    <thead>
                        <tr><th>Rank</th><th>Section</th><th class="text-center">Transactions</th></tr>
                    </thead>
                    <tbody>
